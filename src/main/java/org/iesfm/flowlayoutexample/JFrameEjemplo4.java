 ...
 */
public class JFrameEjemplo4 extends javax.swing.JFrame {

    /**
     * Creates new form JFrameEjemplo4
     */
    public JFrameEjemplo4() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameEjemplo4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameEjemplo4().setVisible(true);
            }
        });
    }
